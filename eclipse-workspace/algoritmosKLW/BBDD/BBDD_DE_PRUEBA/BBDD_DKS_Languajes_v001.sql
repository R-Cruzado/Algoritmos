...
CREATE DATABASE IF NOT EXISTS dos_dkslanguajes CHARSET = utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `dos_dkslanguajes`;  /* Aqui se identifica la base de datos  */
...
SET @locDKSLocal_ai_es = @locDKSLocal+"/lan_es";  
SET @locDKSLocal_ai_ing = @locDKSLocal+"/lan_ing";
