        ...
        while ($row = mysqli_fetch_assoc($grafo)){
            ...
            if ($row['IdRelPadre'] == $inicio['IdRel']){
                ...
                if (! in_array($row['ClaveHijo'], $visitados)){
                    ...
                    /*
                     * Se llama a la función encolar para añadir el nodo a la cola de prioridad
                     * devuelve los parámetros modificados por referencia
                     */
                    encolar($row, $contadorReferencias, $contador, $ColaPrioridad);
                }
                /*
...
//Funcion auxiliar para añadir la tupla encontrada a la cola de prioridad. Con & devuelve los parámetros por referencia
function encolar($row, &$contadorReferencias, &$contador, &$ColaPrioridad){
