...
//Llamada a otro DKS
function conexionOtroDKS($inicio, $gen2, $algoritmo, $genes, $profundidadActual){

    //print $inicio['ClaveHijo']." ".$gen2." ".$algoritmo." ".$genes." ".$profundidadActual." ";
...
function curl_download($Url, $post_data){
    ...
    //concatenar salida web local con las salidas de cURL
